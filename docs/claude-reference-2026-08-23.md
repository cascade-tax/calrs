# Cal.rs reference snapshot (archived 2026-08-23)

Historical development context moved out of the always-loaded instructions.
Use the source tree, README, mdBook, and MAINTAINERS.md for current guidance.
