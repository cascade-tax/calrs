...
book-email-invalid = Podaj pełny adres e-mail wraz z domeną (np. jane@example.com).
...
book-phone-invalid = Podaj numer, na który możemy wysłać SMS, albo zostaw pole puste.
...
auth-error-rate-limited = Zbyt wiele prób logowania. Spróbuj ponownie później.
...
auth-error-email-invalid = Podaj prawidłowy adres e-mail
...
form-error-slug-reserved = Ten identyfikator jest zarezerwowany. Wybierz inny.
...
form-error-no-account = Nie znaleziono profilu planowania. Skontaktuj się z administracją.
...
settings-error-booking-email = Podaj prawidłowy adres e-mail do rezerwacji.
...
error-oauth-invalid-state = Nieprawidłowy parametr stanu. Spróbuj ponownie.
