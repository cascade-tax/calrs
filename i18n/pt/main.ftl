...
book-phone-invalid = Informe um número para o qual possamos enviar SMS, ou deixe o campo em branco.
...
register-submit = Criar a conta
register-have-account = Já tem uma conta? { $link }
register-signin-link = Entre

# Authentication errors (src/auth.rs)

auth-error-rate-limited = Muitas tentativas de login. Tente novamente mais tarde.
...
auth-error-email-invalid = Informe um endereço de e-mail válido
...
form-error-slug-reserved = Este identificador é reservado. Escolha outro.
...
form-error-no-account = Nenhum perfil de agendamento encontrado. Fale com a administração.
...
settings-error-booking-email = Informe um endereço de e-mail de agendamento válido.
...
error-oauth-invalid-state = Parâmetro de estado inválido. Tente novamente.
