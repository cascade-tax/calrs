...
book-email-invalid = Inserisci un indirizzo e-mail completo, dominio incluso (per es. jane@example.com).
...
book-phone-help = I numeri locali vanno bene; se non inizi con +, si presume { $country }.
...
book-phone-invalid = Inserisci un numero a cui possiamo inviare SMS, oppure lascia il campo vuoto.
...
settings-dynamic-group-help = Se attivo, altri utenti possono creare URL di incontro collettivo estemporanee che ti includono (per es. { $example }).
...
auth-error-email-invalid = Inserisci un indirizzo e-mail valido
...
form-error-slug-reserved = Questo identificativo è riservato. Scegline un altro.
...
form-error-no-account = Nessun profilo di pianificazione trovato. Rivolgiti all'amministrazione.
...
settings-error-booking-email = Inserisci un indirizzo e-mail valido per le prenotazioni.
...
error-oauth-invalid-state = Parametro di stato non valido. Riprova.
