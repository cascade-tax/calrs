...
book-email-invalid = Sisesta täielik e-posti aadress koos domeeniga (nt mari@example.com).
...
book-phone-invalid = Sisesta number, millele saame lühisõnumi saata, või jäta väli tühjaks.
...
auth-error-rate-limited = Liiga palju sisselogimiskatseid. Proovi hiljem uuesti.
...
auth-error-email-invalid = Sisesta kehtiv e-posti aadress
...
form-error-no-account = Ajaplaneerimise profiili ei leitud. Võta ühendust haldajaga.
...
settings-error-booking-email = Sisesta kehtiv broneeringute e-posti aadress.
